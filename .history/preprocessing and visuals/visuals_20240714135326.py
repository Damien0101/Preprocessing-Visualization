...
living_area_lower = 25
living_area_upper = 1500
surface_of_plot_lower = 50
surface_of_plot_upper = 50000
...
axes[0].set_xlim(surface_of_plot_lower, surface_of_plot_upper)
axes[0].set_ylim(price_lower_bound, price_upper_bound)
...
axes[1].set_xlim(living_area_lower, living_area_upper)
axes[1].set_ylim(price_lower_bound, price_upper_bound)
