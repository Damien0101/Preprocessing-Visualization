...
dataclean.convert_to_numbers("District", {'Brussels': 1,'Antwerp': 2,'Liège': 3,'Brugge': 4,'Halle-Vilvoorde': 5,'Gent': 6,'Turnhout': 7,'Nivelles': 8,'Leuven': 9,'Oostend': 10,'Mechelen': 11,'Aalst': 12,'Kortrijk': 13,'Namur': 14,'Hasselt': 15,'Veurne': 16,'Sint-Niklaas': 17,'Charleroi': 18,'Mons': 19,'Verviers': 20,'Dendermonde': 21,
    'Roeselare': 22,
    'Tournai': 23,
    'Soignies': 24,
    'Oudenaarde': 25,
