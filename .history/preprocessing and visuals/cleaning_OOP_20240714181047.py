...
list_of_cities = [district for district in dataclean.df["Refnis code"].values]
dict_districts = {list_of_districts[i]: i+1 for i in list_of_districts}

dataclean.convert_to_numbers()
