...
dataclean.rename_values("FloodingZone", {"RECOGNIZED_N_CIRCUMSCRIBED_FLOOD_ZONE":"CIRCUMSCRIBED_FLOOD_ZONE ", "A++":"A", "A_A+": "A"})
...
dataclean.convert_to_numbers("FloodingZone", {'RECOGNIZED_FLOOD_ZONE': 1, 'POSSIBLE_FLOOD_ZONE': 2, 'CIRCUMSCRIBED_FLOOD_ZONE': 3, 'USA_INSTALLED': 4, 'SEMI_EQUIPPED': 5, 'USA_SEMI_INSTALLED': 6, 'HYPER_EQUIPPED': 7, 'USA_HYPER_EQUIPPED': 8})
...
print(final_df.FloodingZone.value_counts())