...
sns.sets(style="whitegrid")
palette = sns.color_palette("viridis", as_cmap=True)
plt.figure(figsize=(12, 8))
sns.boxplot(data=final_df, x="PEB", y="ConstructionYear", order=PEB_values, palette=palette)
plt.xlabel("PEB Score", fontsize=14, fontweight='bold')
plt.ylabel("Construction Year", fontsize=14, fontweight='bold')
plt.title("Relationship Between Properties Construction Year and Energy Performance", fontsize=16, fontweight='bold')
