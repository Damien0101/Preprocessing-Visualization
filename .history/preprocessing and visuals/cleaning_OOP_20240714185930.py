...
dataclean.remove_incoherent_values("SurfaceOfPlot", "Price", 1.5, "TypeOfSale", "residential_sale")
dataclean.remove_incoherent_values("SurfaceOfPlot", "Price", 1.5, "TypeOfSale", "residential_monthly_rent")
dataclean.remove_incoherent_values("LivingArea", "Price", 1.5, "TypeOfSale", "residential_sale")
dataclean.remove_incoherent_values("LivingArea", "Price", 1.5, "TypeOfSale", "residential_monthly_rent")

print(dataclean.df.shape)

dataclean.remove_incoherent_values("BedroomCount", "Price", 2)
dataclean.remove_incoherent_values("LivingArea", "BedroomCount", 2)
dataclean.remove_incoherent_values("BathroomCount", "BedroomCount", 1.5)
dataclean.remove_incoherent_values("ToiletCount", "BedroomCount", 1.5)
dataclean.remove_incoherent_values("ShowerCount", "BedroomCount", 1.5)
