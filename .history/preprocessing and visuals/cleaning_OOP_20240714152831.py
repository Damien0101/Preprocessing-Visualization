...
dataclean.convert_to_numbers("TypeOfSale", {"residential_sale": 2, "residential_monthly_rent": 1})
dataclean.convert_to_numbers("Region", {"Wallonie": 1, "Brussels": 2, "Brussels": 3})
