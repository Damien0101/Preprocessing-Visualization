...
dataclean.convert_to_numbers("FloodingZone", {'RECOGNIZED_FLOOD_ZONE': 1, 'POSSIBLE_FLOOD_ZONE': 2, 'CIRCUMSCRIBED_FLOOD_ZONE': 3, 'POSSIBLE_N_CIRCUMSCRIBED_FLOOD_ZONE': 4, 'RECOGNIZED_N_CIRCUMSCRIBED_WATERSIDE_FLOOD_ZONE': 5, 'CIRCUMSCRIBED_WATERSIDE_ZONE': 6, 'POSSIBLE_N_CIRCUMSCRIBED_WATERSIDE_ZONE': 7, 'USA_HYPER_EQUIPPED': 8})
